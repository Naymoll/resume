...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Huge Maksim Sokolov \vspace{2pt}} & % row = 1, col = 1
  Saint-Petersburg, Russia \\ % row = 1, col = 2
  \href{https://t.me/real_naymoll}{\includegraphics[width=18pt]{telegram-mark.png}} % row = 2, col = 1
  \href{https://github.com/Naymoll}{\includegraphics[width=18pt]{github-mark.png}} & % row = 2, col = 2
  \href{mailto:naymoll@yandex.ru}{\uline{naymoll@yandex.ru}} $|$ % row = 2, col = 3
  +7 (923) 314-02-80 \\ % row = 2, col = 4
\end{tabular*}
%--------------------------------------------
...
\resumeHeadingListStart{}
    \resumeQuadHeading{Rust Developer}{August 2023 -- Present}
    {T-Bank}{Saint-Petersburg}

    \resumeQuadHeading{Go Developer}{February 2023 -- August 2023}
    {Solution Factory}{Remote}
    \resumeItemListStart{}
        \resumeItem{Designed and implemented a Server-Driven UI service using DivKit}
        \resumeItem{Created a service for managing sales documents}  
        \resumeItem{Developed and maintained a sales system for standalone vending machines, optimizing performance}  
        \resumeItem{Built a user verification library via cell phone authentication}  
    \resumeItemListEnd{}

    \resumeQuadHeading{Junior Rust Developer}{August 2021 -- November 2022}
    {Atlas Delivery}{Remote}
    \resumeItemListStart{}
        \resumeItem{Developed and maintained a service for solving vehicle routing problems}  
        \resumeItem{Designed and built a tool to extract public transportation data from OpenStreetMap}  
        \resumeItem{Developed a Rust library leveraging the C++ OSRM library for routing}  
        \resumeItem{Optimized microservices performance using Profile-Guided Optimization (PGO)}
    \resumeItemListEnd{}
...
\section{Education}
  \resumeHeadingListStart{}
    ...
    {PhD in Engineering}{2024 -- Present}
...
\section{Skills}
  \resumeHeadingListStart{}
    ...
    \resumeSectionType{Prog. Languages}{}{Rust, C++, Go, Python}
    \resumeSectionType{Rust}{}{Axum, Actix Web, Tokio, Hyper}
    \resumeSectionType{Go}{}{Gin, Bun}
    \resumeSectionType{C++}{}{STL, Qt, CMake}
    % \resumeSectionType{Python/ML}{}{PyTorch, NLTK, NumPy, scikit-learn}
    \resumeSectionType{Databases}{}{PostgreSQL, T-SQL, MongoDB}
    \resumeSectionType{Technologies}{}{Git, Docker, Kafka, Prometheus, Elasticsearch, Linux}
...
\resumeItemListStart{}
    \resumeItem{Dubovskoi, A. A., Baimuratov, I. R., \& Sokolov, M. V. (2024). Informed Object Detection for Computer Games. Pattern Recognition and Image Analysis, 34(3), 810-818.}
\resumeItemListEnd{}
